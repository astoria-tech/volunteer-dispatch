...
const config = {
  ...
  AIRTABLE_REQUESTERS_TABLE_NAME:
    process.env.AIRTABLE_REQUESTERS_TABLE_NAME || "Requesters",
  AIRTABLE_USERS_VIEW_NAME: process.env.AIRTABLE_USERS_VIEW_NAME || "Grid view",
