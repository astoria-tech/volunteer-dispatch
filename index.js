...
const ERRAND_REQUIREMENTS = {
  'Grocery shopping': ['Picking up groceries/medications'],
  'Picking up a prescription': ['Picking up groceries/medications'],
  'Transportation to/from a medical appointment': ['Transportation'],
  'Dog walking': ['Pet-sitting/walking/feeding'],
  Loneliness: [
  ...
  base('Requests')
    ...
    .eachPage(async (records, nextPage) => {
      ...
      await asyncForEach(records, async (record) => {
        ...
        if (volunteers.length > 0) {
          ...
          volunteers.forEach((volunteer) => {
            ...
            volObject.push({
              ...
              text: {
                type: 'mrkdwn',
                text: `<${volunteerURL}|${volunteer.Name}> - ${
                  volunteer.Number
        ...
        const slackRes = await sendMessage(errandObject, taskObject, volObject);
